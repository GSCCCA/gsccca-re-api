...
namespace PRIALibraryV24
{
    ...
    public partial class PRIA_REQUEST_GROUP_Type
    {
        ...
        {
            PRIA_PACKAGE_Type package = null;

            if (this.REQUEST.Count > 0 &&
               this.REQUEST[0] != null &&
               this.REQUEST[0].PRIA_REQUEST != null &&
               this.REQUEST[0].PRIA_REQUEST.Count > 0 &&
               this.REQUEST[0].PRIA_REQUEST[0].PACKAGE != null &&
               this.REQUEST[0].PRIA_REQUEST[0].PACKAGE.Count > 0 &&
               this.REQUEST[0].PRIA_REQUEST[0].PACKAGE[0] != null)
            {
                package = this.REQUEST[0].PRIA_REQUEST[0].PACKAGE[0];
            }
            return package;
        }
